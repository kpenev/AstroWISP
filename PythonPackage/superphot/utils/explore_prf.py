...
def parse_command_line(parser=None):
    ...
    spline_config.add_argument(
        ...
        type=int,
        default=300,
        help='The number of evenly spaced points to pass to the spline for x and y'
             'Default: %(default)s.'
    )
    ...
    plot_config.add_argument(
        ...
        default=60,
        type=int,
        help='The stride amount (int) for the 3D contour plot generated by plot-3d-spline'
    )
    plot_config.add_argument(
        '--plot-3d-spline-contour-linewidths',
        default=60.0,
        type=float,
        help='The The line width of the contour lines (float) for the 3D contour plot generated by plot-3d-spline'
    )
    plot_config.add_argument(
        '--plot-multi-image',
        action='store_true',
...
def plot_3d_prf(cmdline_args, meshgrid_x, meshgrid_y, prf_slice_splines):
    ...
    Args:
        ...
        meshgrid_x, meshgrid_y:   The meshgrid generated for evaluating the PRF made from the
                grid points of the star_shape_grid
    ...
    def plot_3d_slice(spline, meshgrid_x, meshgrid_y, stride, linewidths):
        ...
        ax = pyplot.axes(projection='3d')
        ax.contour3D(meshgrid_x, meshgrid_y, spline.reshape(meshgrid_x.shape), stride)
    ...
    def get_3d_plot_tasks(cmdline_args):
        ...
        Yields:
            ...
            str or None: The filename to save a combined plot of all pieces of the
